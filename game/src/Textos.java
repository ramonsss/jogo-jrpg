...
public class Textos {
    ...
    public void faceInimigo1() {
        ...
        System.out.println("Voces realmente acham que podem se livrar de mim tão facilmente?, VENCEREI VOCE " + RED 
    ...
    public void finalFrase() {
        ...
        System.out.println("MEU DEUSSSSS EU FINALMENTE ENXERGO DE NOVO AS CORES, AGORA EU RELEMBRO A TRIBO DO SO UM BITZINHO\n");
        ...
        System.out.println("FILHO? pera VOCE EH MEU PAI, MARIO SERGIO CORTELLA ALEMAOZINHO????????? MDSS... AGORA EU ME LEMBRO DE VOCE");
        System.out.println("\nPAI?...");
        pause.pauseConsole();
        clear.clearConsole();
