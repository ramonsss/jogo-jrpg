...
public class App {
            ...
            if (escolha == 1) {
                ...
                if (personagem.pointUp == 0) {
                    ...
                    if (personagem.getPv() > 0) {
                        ...
                        batalha.combateBattle2(personagem, inimigo, arma, armadura, mana, pocao);
                    }
                    ...
                    if (personagem.getName() == "Mago Giras") {
                        ...
                        if (personagem.getPv() > 0) {
                            clear.clearConsole();
                            System.out.println("Sua vida é fase 2morta:" + personagem.getPv());
                    ...
                    if (personagem.getPv() > 0) {
                        ...
                        batalha.combateBattle3(personagem, inimigo, arma, armadura, mana, pocao);
                        textos.finalFrase();
                    }
                }
                ...
                System.out.println("agora você já pode começar essa aventura.");
                pause.pauseConsole();
                clear.clearConsole();
            }
    ...
    private static void selectArmor(Personagem personagem, Armadura armadura, Arma arma, Mana mana) {
        ...
        if (personagem.getArmadurasUsadas().contains(escolhaArmadura)) {
            System.out.println("Você já usou essa armadura antes. Escolha outra.");
        } else {
